...
import com.nixsolutions.laboratorysixteen.exception.RecaptchaServiceException;
import com.nixsolutions.laboratorysixteen.model.RecaptchaModel;
import com.nixsolutions.laboratorysixteen.service.RecaptchaService;
...
public class RecaptchaFormValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        RecaptchaModel form = (RecaptchaModel) target;
        try {
