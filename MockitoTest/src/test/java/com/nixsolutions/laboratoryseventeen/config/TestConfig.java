...
@ComponentScan({ "com.nixsolutions.laboratoryseventeen.dao", "com.nixsolutions.laboratoryseventeen.entity"})
	   ...
	   public LocalSessionFactoryBean sessionFactory(DataSource dataSource, Environment env) {
		...
		sessionFactory.setDataSource(dataSource);
		 sessionFactory.setPackagesToScan(
			        new String[] { "com.nixsolutions.laboratoryseventeen.dao", "com.nixsolutions.laboratoryseventeen.entity" });
...
//				setProperty("hibernate.shema.init", env.getProperty("hibernate.shema.init"));
			}
		};
	}
}
