...
@ComponentScan({ "com.nixsolutions.laboratoryeighteen.dao", "com.nixsolutions.laboratoryeighteen.entity"})
	   ...
	   public LocalSessionFactoryBean sessionFactory(DataSource dataSource, Environment env) {
		...
		sessionFactory.setDataSource(dataSource);
		 sessionFactory.setPackagesToScan(
			        new String[] { "com.nixsolutions.laboratoryeighteen.dao", "com.nixsolutions.laboratoryeighteen.entity" });
